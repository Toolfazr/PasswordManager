...
{
    ui->basePlainText->setPlainText(str);
    ui->topPwDisplayItem->hide();
    ui->midPwDisplayItem->hide();
    ui->bottomPwDisplayItem->hide();
    ui->basePlainText->show();
    ui->basePlainText->update();
}
...
{
    showMsg("\r\n\r\n\r\n\r\n\r\n               " + QString("fail to verify finger, times: %1").arg(failTimes));
}

void MainWindow::tipNeedRestart()
{
    showMsg("\r\n\r\n\r\n\r\n\r\n         no ack, suggest restart this application");
}

void MainWindow::tipFingerVfySuccess()
{
    showMsg("\r\n\r\n\r\n\r\n\r\n                        finger verify success");
}
